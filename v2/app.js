...
function bindSettingsEvents() {
  ...
  document.getElementById('showSimilarToggle').addEventListener('change', e => { if (pendingSettings) pendingSettings.showSimilar = e.target.checked; });
